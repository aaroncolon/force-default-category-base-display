...
class FDCBD {
	...
	public function boot() {
		add_action( 'template_redirect', array( $this,  'prepend_default_category_base' ) );
	}
	 ...
	 * @return void
	 */
	public function prepend_default_category_base() {
		// is_404() returns true on paginated "bare" category archives
	 ...
	 */
	public function is_category( $wp ) {
